...
import static org.stipendj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.stipendj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.stipendj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
