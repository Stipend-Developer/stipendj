...
import org.stipendj.core.listeners.TransactionConfidenceEventListener;
import org.stipendj.core.AbstractBlockChain;
import org.stipendj.core.Address;
import org.stipendj.core.Block;
import org.stipendj.core.BlockChain;
import org.stipendj.core.Coin;
import org.stipendj.core.ECKey;
import org.stipendj.core.InsufficientMoneyException;
import org.stipendj.core.PeerAddress;
import org.stipendj.core.Sha256Hash;
import org.stipendj.core.StoredBlock;
import org.stipendj.core.Transaction;
import org.stipendj.core.TransactionConfidence;
import org.stipendj.core.TransactionInput;
import org.stipendj.core.TransactionOutPoint;
import org.stipendj.core.TransactionOutput;
import org.stipendj.core.Utils;
import org.stipendj.core.VerificationException;
import org.stipendj.core.TransactionConfidence.ConfidenceType;
import org.stipendj.crypto.*;
import org.stipendj.script.Script;
import org.stipendj.script.ScriptBuilder;
import org.stipendj.signers.StatelessTransactionSigner;
import org.stipendj.signers.TransactionSigner;
import org.stipendj.store.BlockStoreException;
import org.stipendj.store.MemoryBlockStore;
import org.stipendj.testing.*;
import org.stipendj.utils.ExchangeRate;
import org.stipendj.utils.Fiat;
import org.stipendj.utils.Threading;
import org.stipendj.wallet.Wallet.BalanceType;
import org.stipendj.wallet.WalletTransaction.Pool;
...
import org.stipendj.wallet.Protos.Wallet.EncryptionType;
...
import static org.stipendj.core.Utils.HEX;
import static org.stipendj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: stipendj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("stipendj-unit-test", null);
