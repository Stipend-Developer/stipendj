...
import org.stipendj.protocols.channels.*;
import org.stipendj.store.*;
import org.stipendj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV stipendj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit stipendj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing stipendj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.stipendj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the stipendj website for further details.
     */
    ...
    protected void startUp() throws Exception {
        ...
        try {
            ...
            // Initiate Stipend network objects (block store, blockchain and peer group)
