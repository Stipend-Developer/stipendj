...
import org.stipendj.net.*;
import org.stipendj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of stipendj fixes the known
     ...
     * {@link org.stipendj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.stipendj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.stipendj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.stipendj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.stipendj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.stipendj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.stipendj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.stipendj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.stipendj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a stipendj based app running in SPV mode to fully validating security.
     */
