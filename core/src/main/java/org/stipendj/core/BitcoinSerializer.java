...
import static org.stipendj.core.Transaction.MAX_STANDARD_TX_SIZE;
import static org.stipendj.core.Utils.*;

/**
 * <p>Methods to serialize and de-serialize messages to the Stipend network format as defined in
