...
import org.stipendj.crypto.TransactionSignature;
...
import static org.stipendj.core.Utils.*;
...
public class Transaction extends ChildMessage {
     ...
     */
    public static final Coin DEFAULT_TX_FEE = Coin.valueOf(CoinDefinition.DEFAULT_TX_FEE);
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.stipendj.script.Script, ECKey, org.stipendj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.stipendj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.stipendj.core.TxConfidenceTable}
