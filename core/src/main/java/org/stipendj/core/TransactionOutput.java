...
public class TransactionOutput extends ChildMessage {
     ...
     *
     * <p>You probably should use {@link org.stipendj.core.TransactionOutput#getMinNonDustValue()} which uses
    ...
    public Coin getMinNonDustValue() {
        return getMinNonDustValue(Transaction.DEFAULT_TX_FEE.multiply(3));
    }
