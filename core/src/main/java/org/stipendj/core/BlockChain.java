...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.stipendj.store.SPVBlockStore} or you could also try a
     * {@link org.stipendj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
