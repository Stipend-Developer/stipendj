...
import org.stipendj.net.discovery.HttpDiscovery;
import org.stipendj.params.*;
import org.stipendj.script.Script;
import org.stipendj.script.ScriptBuilder;
import org.stipendj.script.ScriptChunk;
import org.stipendj.script.ScriptOpCodes;
import org.stipendj.store.BlockStore;
import org.stipendj.store.BlockStoreException;
import org.stipendj.utils.MonetaryFormat;
...
import org.stipendj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.stipendj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.stipendj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.stipendj.core.DumpedPrivateKey}. */
     ...
     * test and main Stipend networks use 2 weeks (1209600 seconds).
     */
    ...
    /**
     * The key used to sign {@link org.stipendj.core.AlertMessage}s. You can use {@link org.stipendj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
