...
import org.stipendj.net.AbstractTimeoutHandler;
import org.stipendj.net.MessageWriteTarget;
 ...
 * {@link org.stipendj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.stipendj.net.NioClient} or
     * {@link org.stipendj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
