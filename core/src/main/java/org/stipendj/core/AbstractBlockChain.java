 ...
 * the lightweight SPV mode, a {@link org.stipendj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.stipendj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
