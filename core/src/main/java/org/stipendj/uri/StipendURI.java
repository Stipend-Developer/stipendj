...
import org.stipendj.params.AbstractBitcoinNetParams;
...
public class StipendURI {
    ...
    /**
     * URI for Stipend network. Use {@link org.stipendj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.stipendj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new StipendURI from the given string. Can be for any network.
     *
     ...
     */
    public StipendURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public StipendURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("StipendURI[");
        boolean first = true;
