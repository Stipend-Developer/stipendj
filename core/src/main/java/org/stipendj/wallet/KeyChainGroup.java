...
/**
 * <p>A KeyChainGroup is used by the {@link org.stipendj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.stipendj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.stipendj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.stipendj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
