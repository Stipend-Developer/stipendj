...
import org.stipendj.core.BloomFilter;
 ...
 * {@link org.stipendj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.stipendj.crypto.MnemonicCode},
 ...
 * {@link org.stipendj.crypto.DeterministicKey#serializePubB58(org.stipendj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.stipendj.crypto.DeterministicKey#deserializeB58(org.stipendj.crypto.DeterministicKey, String, org.stipendj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.stipendj.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.stipendj.crypto.DeterministicHierarchy} and
 * {@link org.stipendj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from stipendj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.stipendj.crypto.DeterministicKey)}
     ...
     * @see org.stipendj.wallet.MarriedKeyChain
     */
