...
import org.stipendj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.stipendj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.stipendj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.stipendj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
