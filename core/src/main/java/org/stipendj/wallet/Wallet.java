...
import org.stipendj.core.Message;
import org.stipendj.core.listeners.*;
import org.stipendj.core.TransactionConfidence.*;
import org.stipendj.crypto.*;
import org.stipendj.script.*;
import org.stipendj.signers.*;
import org.stipendj.utils.*;
import org.stipendj.wallet.Protos.Wallet.*;
import org.stipendj.wallet.WalletTransaction.*;
import org.stipendj.wallet.listeners.KeyChainEventListener;
import org.stipendj.wallet.listeners.ScriptsChangeEventListener;
import org.stipendj.wallet.listeners.WalletChangeEventListener;
import org.stipendj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.stipendj.wallet.listeners.WalletCoinsSentEventListener;
import org.stipendj.wallet.listeners.WalletEventListener;
import org.stipendj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.stipendj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.stipendj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.stipendj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.stipendj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.stipendj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.stipendj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.stipendj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.stipendj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.stipendj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.stipendj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.stipendj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.stipendj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.stipendj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.stipendj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of stipendj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.stipendj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.stipendj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.stipendj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.stipendj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.stipendj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.stipendj.crypto.KeyCrypter,
     ...
     * {@link org.stipendj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.stipendj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.stipendj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.stipendj.signers.TransactionSigner.MissingSignatureException}
     ...
     * sending transactions to the Stipend network by default. Some sendCoins methods let you specify a broadcaster
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.stipendj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.stipendj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
