...
import static wallettemplate.Main.stipend;
...
public class MainController {
    ...
    public void onBitcoinSetup() {
        model.setWallet(stipend.wallet());
        ...
        // Don't let the user click send money when the stipend is empty.
        sendMoneyOutBtn.disableProperty().bind(model.balanceProperty().isEqualTo(Coin.ZERO));

        TorClient torClient = Main.stipend.peerGroup().getTorClient();
        if (torClient != null) {
    ...
    private void showBitcoinSyncMessage() {
        syncItem = Main.instance.notificationBar.pushItem("Synchronising with the Stipend network", model.syncProgressProperty());
    }
