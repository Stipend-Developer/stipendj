...
import org.stipendj.kits.WalletAppKit;
...
/**
 * The following example shows how to use the by stipendj provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV stipendj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // stipendj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://github.com/google/guava/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();
